...
export default class Options {
  ...
  init() {
    ...
    console.log('Options subscribed');
  }
  ...
  update() {
    ...
    if (!on) {
      console.log('Options unsubscribed');
      this.unsubscribe();
    }
  }
  ...
  addOption() {
    ...
    newOption.innerHTML = `<div class="option-wrapper">
      ...
      <input
        ...
        type="text"
      />
      <button id="rm-${newKey}" class="rm-option-btn icon-minus"></button>
    </div>`;
        ...
        .map((key, idx) => `<li class="option">
          <div class="option-wrapper">
            ...
            <input 
              ...
              value="${options[key]}"
            />
            ${idx >= 1 ? `<button id="rm-${key}" class="rm-option-btn icon-minus"></button>` : ''}
          </div>
        </li>`)
        .join('');
  ...
  render() {
    ...
    : answer === k
      ? 'checked' : ''}
            ...
            />
            ${idx >= 1
    ? `<button id="rm-${k}" class="rm-option-btn icon-minus" aria-label="delete option"></button>`
    : ''}
          </div>
        </li>`).join('')}
      </ul>
      <button class="add-option-btn icon-list-add" aria-label="add option"></button>
